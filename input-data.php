...
/* FUNCTION SAFE GET */
function getData($conn, $table, $wilayah_id)
{
    if (!$wilayah_id)
        return [];
...
/* LOAD DATA */
$batas_jarak = getData($conn, 'wilayah_batas_jarak', $wilayah_id);
$demografi = getData($conn, 'demografi', $wilayah_id);
$sarana = getData($conn, 'sarana', $wilayah_id);
$program_bantuan = getData($conn, 'program_bantuan', $wilayah_id);
$pendidikan = getData($conn, 'pendidikan', $wilayah_id);
$aparatur_lembaga = getData($conn, 'aparatur_lembaga', $wilayah_id);
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="topbar d-flex justify-content-between align-items-center mb-3">
                ...
                <h5 class="mb-0">Form Monografi</h5>
        ...
        <div class="d-flex align-items-center gap-2 text-muted">
            ...
            <span><?= $_SESSION['username'] ?? 'User' ?></span>
                    ...
                    <!-- ACTION BUTTON -->
                    <div class="btn-group">
                        <a href="<?= $dashboard_url ?>" class="btn btn-outline-secondary btn-sm d-flex align-items-center gap-1">
            ...
            <form action="simpan-data.php" method="POST">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active p-4" id="identitas">
                        ...
                        <label>Tahun</label>
                        <input class="form-control mb-2" name="tahun" value="<?= $program_bantuan['tahun'] ?? '' ?>">
    ...
    <div class="card card-custom p-4">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <textarea class="form-control" name="program_pusat" rows="4"><?= htmlspecialchars($program_bantuan['program_pusat'] ?? '') ?></textarea>
            </div>

            <div class="col-md-4 mb-3">
                <label>Program Provinsi</label>
                <textarea class="form-control" name="program_provinsi" rows="4"><?= htmlspecialchars($program_bantuan['program_provinsi'] ?? '') ?></textarea>
            </div>

            <div class="col-md-4 mb-3">
                <label>Program Kabupaten</label>
                <textarea class="form-control" name="program_kabupaten" rows="4"><?= htmlspecialchars($program_bantuan['program_kabupaten'] ?? '') ?></textarea>
            </div>
