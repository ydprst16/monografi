...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    ========================== */ elseif (isset($_POST['ubah_password'])) {
        ...
        if ($new_password !== $confirm_password) {
            ...
            $forgot_error = "Password tidak cocok!";

        } elseif (strlen($new_password) < 6) {

            $forgot_error = "Password minimal 6 karakter.";

        } elseif (!preg_match('/[A-Za-z]/', $new_password) || !preg_match('/[0-9]/', $new_password)) {

            $forgot_error = "Password harus mengandung huruf dan angka.";
            ...
            if ($result->num_rows == 0) {
                ...
                $forgot_error = "Username tidak ditemukan!";
                ...
                if ($stmt_update->execute()) {
                    ...
                    $forgot_success = "Password berhasil diubah. Silakan login.";
                    log_activity($conn, $username, "Mengubah password");

                } else {

                    $forgot_error = "Gagal mengubah password.";
